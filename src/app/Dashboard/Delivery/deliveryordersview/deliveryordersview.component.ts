...
@Component({
  selector: 'app-deliveryordersview',
  imports: [RouterModule],
  templateUrl: './deliveryordersview.component.html',
  styleUrl: './deliveryordersview.component.css'
})
export class DeliveryordersviewComponent {
...
<body onload="window.print(); window.close();">
    <div class="container">
      ...
      <div class="footer-section">
        <div class="signature">
         <span class="signa">Anshul Mokhale</span>
