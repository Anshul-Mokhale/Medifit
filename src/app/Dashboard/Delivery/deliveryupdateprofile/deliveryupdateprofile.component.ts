...
@Component({
  selector: 'app-deliveryupdateprofile',
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './deliveryupdateprofile.component.html',
  styleUrl: './deliveryupdateprofile.component.css'
})
export class DeliveryupdateprofileComponent implements OnInit {
