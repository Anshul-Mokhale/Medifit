...
@Component({
  selector: 'app-adminorderprocessed',
  imports: [RouterModule, FormsModule, NgClass, NgFor],
  templateUrl: './adminorderprocessed.component.html',
  styleUrl: './adminorderprocessed.component.css'
})
export class AdminorderprocessedComponent {
  users: Health[] = [];
